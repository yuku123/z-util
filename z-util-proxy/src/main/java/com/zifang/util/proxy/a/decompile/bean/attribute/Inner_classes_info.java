...
public class Inner_classes_info {
    ...
    private String inner_class_access_flags;
    ...
    public String getInner_class_access_flags() {
        return inner_class_access_flags;
    }

    public void setInner_class_access_flags(String inner_class_access_flags) {
