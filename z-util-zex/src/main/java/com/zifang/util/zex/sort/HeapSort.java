 ...
 * 堆排序算法实现类。
 * <p>
 * 堆排序是一种树形选择排序，是对直接选择排序的有效改进，是不稳定的排序。
 * <p>
 * 算法复杂度：
 * <ul>
 ...
 * 算法原理：
 * <ol>
 *   <li>根据序列建立大根堆（或小根堆）</li>
 *   <li>将堆顶元素R[1]与最后一个元素R[n]交换，得到新的无序区(R1,R2,......Rn-1)和新的有序区(Rn)，且满足R[1,2...n-1]&lt;=R[n]</li>
 *   <li>对当前无序区(R1,R2,......Rn-1)调整为新堆，然后再次将R[1]与无序区最后一个元素交换</li>
