...
/**
 * @author: zifang
 * @time: 2022-06-08 10:49:00
 * @description: A mutable {@code float} wrapper. Note that as MutableFloat does not extend Float,
...
public class MutableFloat extends Number implements Comparable<MutableFloat>, Mutable<Number>,
     ...
     */
    private static final long serialVersionUID = -2478365362307492919L;
    ...
    /**
     * Compzifang this object against some other object. The result is {@code true} if and only if the
     * argument is not {@code null} and is a {@code Float} object that represents a {@code float} that
     * has the identical bit pattern to the bit pattern of the {@code float} represented by this
     * object. For this purpose, two float values are considered to be the same if and only if the
