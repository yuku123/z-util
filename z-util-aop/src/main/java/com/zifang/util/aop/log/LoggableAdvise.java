package com.zifang.util.aop.log;
 ...
 * <p>
 * 用法：在业务方法上加 {@code @Loggable(LoggableAdvise.class)}，
 * 然后用 {@code ProxyFactory.wrap(...)} 包一层。
 *
 * <pre>{@code
 *   public class OrderService {
 *       @com.zifang.util.trace.log.Loggable(LoggableAdvise.class)
 *       public OrderDto create(String userId, String productId) { ... }
 *   }
 * }</pre>
 *
 * <p>注意：本类是有状态的（Logger 按类缓存，Marker 也缓存），但 {@link #around}
 * 是无状态的——多线程并发安全。
 *
