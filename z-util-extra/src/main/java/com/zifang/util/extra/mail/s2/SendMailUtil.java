package com.zifang.util.extra.mail.s2;
...
/**
 * 邮件发送工具类（网易163邮箱，v2版本）
 * <p>
 * 提供基于网易163邮箱SMTP服务的邮件发送功能，支持动态指定收件人
 *
 * @author zifang
 */
public class SendMailUtil {
     ...
     */
    //1340947819@qq.com
    static String PWD = "zxczxc123";

    /**
     * 邮件标题前缀
     */
    static String SUBJECT = "[ofbiz]";

    /**
     * 发送邮件到指定邮箱
     * <p>
     * 通过网易163邮箱SMTP服务器发送文本邮件到指定收件人
     *
     * @param emailSendTo 收件人邮箱地址，不能为空
     * @param content     邮件正文内容，不能为空
     */
